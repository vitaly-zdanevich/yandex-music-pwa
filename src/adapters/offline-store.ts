...
export interface OfflineStore {
	...
	put(track: Track, audio: Blob, artwork?: Blob, media?: CachedMediaDetails): Promise<CachedTrack>;
...
export class IndexedDbOfflineStore implements OfflineStore {
	...
	async put(track: Track, audio: Blob, artwork?: Blob, media?: CachedMediaDetails): Promise<CachedTrack> {
